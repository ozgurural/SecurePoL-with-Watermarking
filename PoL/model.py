...
class SimpleCNN(nn.Module):
    def __init__(self):
        ...
        self.fc3 = nn.Linear(84, 10)  # For CIFAR-10
...
# Additional definitions for CIFAR100:
class BasicBlock2(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride=1):
        ...
        self.residual_function = nn.Sequential(
            ...
            nn.Conv2d(out_channels, out_channels * BasicBlock2.expansion,
        ...
        if stride != 1 or in_channels != BasicBlock2.expansion * out_channels:
            self.shortcut = nn.Sequential(
                nn.Conv2d(in_channels, out_channels * BasicBlock2.expansion,
...
class BottleNeck2(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride=1):
        ...
        self.residual_function = nn.Sequential(
            ...
            nn.BatchNorm2d(out_channels),
            nn.ReLU(inplace=True),
            nn.Conv2d(out_channels, out_channels * BottleNeck2.expansion,
        ...
        if stride != 1 or in_channels != out_channels * BottleNeck2.expansion:
            self.shortcut = nn.Sequential(
                nn.Conv2d(in_channels, out_channels * BottleNeck2.expansion,
...
def resnet50():
    return ResNet2(BottleNeck2, [3, 4, 6, 3], num_classes=100)
